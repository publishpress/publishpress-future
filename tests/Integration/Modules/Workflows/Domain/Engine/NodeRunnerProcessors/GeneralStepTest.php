...
class GeneralStepTest extends \lucatume\WPBrowser\TestCase\WPTestCase
{
    ...
    public function testPrepareLogMessage(): void
    {
        ...
        $this->assertEquals(
            '[workflow.steps.processors.general]   → Workflow #123 → Setting up step step1',
        ...
        $this->assertEquals(
            '[workflow.steps.processors.general]   → Workflow #123 → Setting up step step1 with title "step title"',
